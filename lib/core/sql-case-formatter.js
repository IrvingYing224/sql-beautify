...
function build_case_formatted_text(prefix_raw, case_operand, when_items, else_value, suffix_text, caseWhenThenWrapLength, else_leading_comments, else_trailing_comment, tokenizerOptions) {
...
function format_case_blocks(str, caseWhenThenWrapLength, tokenizerOptions) {
	...
	for (let i = 0; i < text_list.length; i++) {
		...
		var formatted_block = build_case_formatted_text(prefix_raw, case_operand, when_items, else_value, end_suffix, caseWhenThenWrapLength, else_leading_comments, else_trailing_comment, tokenizerOptions);
