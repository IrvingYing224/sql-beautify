...
var CLAUSES = [
    ...
    { name: 'INTERSECT', keywords: ['INTERSECT'], dialects: ['generic', 'hive', 'postgres'], selectStart: false, selectEnd: true, conditionReset: true },
    { name: 'EXCEPT', keywords: ['EXCEPT'], dialects: ['generic', 'hive', 'postgres'], selectStart: false, selectEnd: true, conditionReset: true }
];
