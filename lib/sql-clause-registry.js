...
var CLAUSES = [
    { name: 'DROP', keywords: ['DROP'], dialects: DIALECTS, selectStart: false, selectEnd: false, conditionReset: true, statementStart: true },
    { name: 'CREATE', keywords: ['CREATE'], dialects: DIALECTS, selectStart: false, selectEnd: false, conditionReset: true, statementStart: true },
    { name: 'ALTER', keywords: ['ALTER'], dialects: DIALECTS, selectStart: false, selectEnd: false, conditionReset: true, statementStart: true },
    { name: 'INSERT', keywords: ['INSERT'], dialects: DIALECTS, selectStart: false, selectEnd: false, conditionReset: true, statementStart: true },
    { name: 'DELETE', keywords: ['DELETE'], dialects: DIALECTS, selectStart: false, selectEnd: false, conditionReset: true, statementStart: true },
    { name: 'SET', keywords: ['SET'], dialects: DIALECTS, selectStart: false, selectEnd: false, conditionReset: true, statementStart: true },
    { name: 'WITH', keywords: ['WITH'], dialects: DIALECTS, selectStart: false, selectEnd: false, conditionReset: true },
    { name: 'RECURSIVE', keywords: ['RECURSIVE'], dialects: ['generic', 'postgres'], selectStart: false, selectEnd: false, conditionReset: false },
    { name: 'SELECT', keywords: ['SELECT'], dialects: DIALECTS, selectStart: true, selectEnd: false, conditionReset: true },
