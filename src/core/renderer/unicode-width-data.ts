...
export const GCB_CONTROL: readonly number[] = Object.freeze([
...
export const GCB_EXTEND: readonly number[] = Object.freeze([
    ...
    0xC81, 0xC81, 0xCBC, 0xCBC, 0xCBF, 0xCBF, 0xCC2, 0xCC2,
    0xCC6, 0xCC6, 0xCCC, 0xCCD, 0xCD5, 0xCD6, 0xCE2, 0xCE3,
...
export const GCB_PREPEND: readonly number[] = Object.freeze([
...
export const GCB_SPACING_MARK: readonly number[] = Object.freeze([
...
export const GCB_ZWJ: readonly number[] = Object.freeze([
    0x200D, 0x200D
]);

export const GCB_REGIONAL_INDICATOR: readonly number[] = Object.freeze([
    0x1F1E6, 0x1F1FF
]);

export const GCB_L: readonly number[] = Object.freeze([
    0x1100, 0x115F, 0xA960, 0xA97C
]);

export const GCB_V: readonly number[] = Object.freeze([
    0x1160, 0x11A7, 0xD7B0, 0xD7C6
]);

export const GCB_T: readonly number[] = Object.freeze([
    0x11A8, 0x11FF, 0xD7CB, 0xD7FB
]);

export const GCB_LV: readonly number[] = Object.freeze([
...
export const GCB_LVT: readonly number[] = Object.freeze([
...
export const INCB_CONSONANT: readonly number[] = Object.freeze([
...
export const INCB_EXTEND: readonly number[] = Object.freeze([
    ...
    0x81B, 0x823, 0x825, 0x827, 0x829, 0x82D, 0x859, 0x85B,
    0x898, 0x89F, 0x8CA, 0x8E1, 0x8E3, 0x8FF, 0x93C, 0x93C,
    0x951, 0x954, 0x9BC, 0x9BC, 0x9FE, 0x9FE, 0xA3C, 0xA3C,
    0xABC, 0xABC, 0xB3C, 0xB3C, 0xC3C, 0xC3C, 0xC55, 0xC56,
    0xCBC, 0xCBC, 0xD3B, 0xD3C, 0xE38, 0xE3A, 0xE48, 0xE4B,
    0xEB8, 0xEBA, 0xEC8, 0xECB, 0xF18, 0xF19, 0xF35, 0xF35,
    0xF37, 0xF37, 0xF39, 0xF39, 0xF71, 0xF72, 0xF74, 0xF74,
    0xF7A, 0xF7D, 0xF80, 0xF80, 0xF82, 0xF84, 0xF86, 0xF87,
    0xFC6, 0xFC6, 0x1037, 0x1037, 0x1039, 0x103A, 0x108D, 0x108D,
    0x135D, 0x135F, 0x1714, 0x1714, 0x17D2, 0x17D2, 0x17DD, 0x17DD,
    0x18A9, 0x18A9, 0x1939, 0x193B, 0x1A17, 0x1A18, 0x1A60, 0x1A60,
    0x1A75, 0x1A7C, 0x1A7F, 0x1A7F, 0x1AB0, 0x1ABD, 0x1ABF, 0x1ACE,
    0x1B34, 0x1B34, 0x1B6B, 0x1B73, 0x1BAB, 0x1BAB, 0x1BE6, 0x1BE6,
    0x1C37, 0x1C37, 0x1CD0, 0x1CD2, 0x1CD4, 0x1CE0, 0x1CE2, 0x1CE8,
    0x1CED, 0x1CED, 0x1CF4, 0x1CF4, 0x1CF8, 0x1CF9, 0x1DC0, 0x1DFF,
    0x200D, 0x200D, 0x20D0, 0x20DC, 0x20E1, 0x20E1, 0x20E5, 0x20F0,
    0x2CEF, 0x2CF1, 0x2D7F, 0x2D7F, 0x2DE0, 0x2DFF, 0x302A, 0x302F,
    0x3099, 0x309A, 0xA66F, 0xA66F, 0xA674, 0xA67D, 0xA69E, 0xA69F,
    0xA6F0, 0xA6F1, 0xA82C, 0xA82C, 0xA8E0, 0xA8F1, 0xA92B, 0xA92D,
    0xA9B3, 0xA9B3, 0xAAB0, 0xAAB0, 0xAAB2, 0xAAB4, 0xAAB7, 0xAAB8,
    ...
    0x10EFD, 0x10EFF, 0x10F46, 0x10F50, 0x10F82, 0x10F85, 0x11070, 0x11070,
    0x1107F, 0x1107F, 0x110BA, 0x110BA, 0x11100, 0x11102, 0x11133, 0x11134,
    0x11173, 0x11173, 0x111CA, 0x111CA, 0x11236, 0x11236, 0x112E9, 0x112EA,
    0x1133B, 0x1133C, 0x11366, 0x1136C, 0x11370, 0x11374, 0x11446, 0x11446,
    0x1145E, 0x1145E, 0x114C3, 0x114C3, 0x115C0, 0x115C0, 0x116B7, 0x116B7,
    0x1172B, 0x1172B, 0x1183A, 0x1183A, 0x1193E, 0x1193E, 0x11943, 0x11943,
    0x11A34, 0x11A34, 0x11A47, 0x11A47, 0x11A99, 0x11A99, 0x11D42, 0x11D42,
    0x11D44, 0x11D45, 0x11D97, 0x11D97, 0x11F42, 0x11F42, 0x16AF0, 0x16AF4,
    0x16B30, 0x16B36, 0x1BC9E, 0x1BC9E, 0x1D165, 0x1D165, 0x1D167, 0x1D169,
    0x1D16E, 0x1D172, 0x1D17B, 0x1D182, 0x1D185, 0x1D18B, 0x1D1AA, 0x1D1AD,
    0x1D242, 0x1D244, 0x1E000, 0x1E006, 0x1E008, 0x1E018, 0x1E01B, 0x1E021,
    0x1E023, 0x1E024, 0x1E026, 0x1E02A, 0x1E08F, 0x1E08F, 0x1E130, 0x1E136,
    0x1E2AE, 0x1E2AE, 0x1E2EC, 0x1E2EF, 0x1E4EC, 0x1E4EF, 0x1E8D0, 0x1E8D6,
    0x1E944, 0x1E94A
]);

export const INCB_LINKER: readonly number[] = Object.freeze([
    0x94D, 0x94D, 0x9CD, 0x9CD, 0xACD, 0xACD, 0xB4D, 0xB4D,
    0xC4D, 0xC4D, 0xD4D, 0xD4D
]);

export const EXTENDED_PICTOGRAPHIC: readonly number[] = Object.freeze([
...
export const EMOJI: readonly number[] = Object.freeze([
...
export const EMOJI_PRESENTATION: readonly number[] = Object.freeze([
...
export const EMOJI_MODIFIER: readonly number[] = Object.freeze([
    0x1F3FB, 0x1F3FF
]);

export const EMOJI_MODIFIER_BASE: readonly number[] = Object.freeze([
...
export const EAST_ASIAN_WIDE_OR_FULLWIDTH: readonly number[] = Object.freeze([
